...
<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
    <div class="navbar-header">
        ...
        <a class="navbar-brand" href="<?php echo BASE_URL . C_ADMIN?>"><?php echo PAGE_TITLE;?></a>
    </div>
    <!-- /.navbar-header -->
    ...
    $left_menu = $admin_menu = array(
                    array('name'=>'Add Survey', 'icon'=>'fa-plus', 'link'=> C_ADMIN . 'add_survey'),
                    array('name'=>'Manage Survey', 'icon'=>'fa-list', 'link'=> C_ADMIN . 'survey'),
                    );
